            ...
            <div className="space-y-6 p-6">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2 rounded-lg border bg-warning-soft px-3 py-1.5 text-warning">
                            <Clock className="size-4" />
                            <span className="text-xs font-semibold">
                                {totalPendingItems} Por preparar
                            </span>
                        </div>
                        <div className="flex items-center gap-2 rounded-lg border bg-info-soft px-3 py-1.5 text-info">
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        className={`space-y-2 rounded-lg border p-3 transition-colors ${
                                                            isPreparing
                                                                ? 'border-card-info-border bg-info-soft dark:border-card-info-border'
                                                                : 'bg-muted/10'
                                                        }`}
                                                    >
                                                        ...
                                                        {/* Notas de Cocina */}
                                                        {item.notes && (
                                                            <div className="rounded border border-card-warning-border bg-warning-soft p-2 text-xs text-warning">
                                                                <strong>
                                                                    Nota:
                                                                </strong>{' '}
                                                                "{item.notes}"
                    ...
                    {filteredOrders.length === 0 && (
                        <div className="col-span-full space-y-2 rounded-xl border border-primary/20 bg-primary-soft/35 py-16 text-center text-muted-foreground">
